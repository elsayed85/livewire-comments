            ...
            <div class="flex gap-4  justify-between">
                ...
                x-on:click.outside="menuOpen = deleteConfirm = false">
                    ...
                    <div class="absolute w-48 bg-white rounded-md shadow-xl right-12">
                        @can('update', $comment)
                        <div x-show="menuOpen" class="p-4 flex items-center gap-2 uppercase text-sm cursor-pointer rounded-md hover:bg-gray-200"
                        ...
                        @endcan
                        @can('delete', $comment)
                        <div x-show="menuOpen" class="p-4 flex gap-2 items-center uppercase text-sm relative cursor-pointer rounded-md hover:bg-gray-200"
